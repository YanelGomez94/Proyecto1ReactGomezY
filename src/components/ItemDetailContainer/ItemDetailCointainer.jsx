...
const MOCK_DATA = [
    ...
    },
    {
      ...
      category: 'Pelicula',
      price: 1000,
      image: "https://pics.filmaffinity.com/m3gan-570441440-mmed.jpg",
    ...
    } ,
    {
      ...
      category: 'Pelicula',
      price: 1000,
      image: "https://img.asmedia.epimg.net/resizer/SUnrzYOwsYtSgZ3Z7tucLtGuWBM=/644x0/cloudfront-eu-central-1.images.arcpublishing.com/diarioas/ABWZCFVNKFIKPHS5DUSBUMSFO4.jpg",
    ...
    },
    {
      ...
      category: 'Serie',
      price: 1000,
      image: "https://www.serieslyawesome.tv/wp-content/uploads/2022/12/friends-serie-sixx.jpg",
      description:"Después de presenciar un incidente extraño y traumático que involucra a un paciente, la Dra. Rose Cotter (Sosie Bacon) comienza a experimentar sucesos aterradores que no puede explicar. A medida que un terror abrumador comienza a apoderarse de su vida, Rose debe enfrentar su inquietante pasado para poder sobrevivir y escapar de su nueva y horrible realidad.",
    },
    {
      id: 6,
      ...
      category: 'Serie',
      price: 1000,
      image: "https://www.noroeste.com.mx/binrepository/939x433/0c1/768d432/none/12707/AHCE/poster_1-2705827_20220927191959.jpg",
      description:"Después de presenciar un incidente extraño y traumático que involucra a un paciente, la Dra. Rose Cotter (Sosie Bacon) comienza a experimentar sucesos aterradores que no puede explicar. A medida que un terror abrumador comienza a apoderarse de su vida, Rose debe enfrentar su inquietante pasado para poder sobrevivir y escapar de su nueva y horrible realidad.",
    }
